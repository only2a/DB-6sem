...
spool "migr_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_migr ...
DROP ROLE ROLE_migr ;
PROMPT Creating Role ROLE_migr ...
CREATE ROLE ROLE_migr ;

-- PROMPT Drop SocialNetwork2 user
-- drop user SocialNetwork2 cascade;
   
PROMPT Create user SocialNetwork2
CREATE USER SocialNetwork2 IDENTIFIED BY &&SocialNetwork2_password PASSWORD EXPIRE ACCOUNT LOCK /* DEFAULT TABLESPACE USERS  TEMPORARY TABLESPACE TEMP */;
GRANT CREATE SESSION, RESOURCE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE SYNONYM, UNLIMITED TABLESPACE TO SocialNetwork2;
...
GRANT ALL ON utils TO ROLE_migr;
grant ALL on utils to SocialNetwork2 with grant option;

set define on
prompt connecting to SocialNetwork2
...
PROMPT Creating Primary Key Constraint PK__Post__3213E83F5ED3CB3D on table Post ... 
ALTER TABLE Post
ADD CONSTRAINT PK__Post__3213E83F5ED3CB3D PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON Post TO ROLE_migr;
...
PROMPT Creating Primary Key Constraint PK__Friendsh__3213E83FA52F849D on table Friendships ... 
ALTER TABLE Friendships
ADD CONSTRAINT PK__Friendsh__3213E83FA52F849D PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON Friendships TO ROLE_migr;
...
PROMPT Creating Primary Key Constraint PK__Comment__3213E83F2D2BC592 on table Comment_ ... 
ALTER TABLE Comment_
ADD CONSTRAINT PK__Comment__3213E83F2D2BC592 PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON Comment_ TO ROLE_migr;
...
PROMPT Creating Primary Key Constraint PK__Users__3213E83FFEFB400A on table Users ... 
ALTER TABLE Users
ADD CONSTRAINT PK__Users__3213E83FFEFB400A PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON Users TO ROLE_migr;
...
PROMPT Creating Primary Key Constraint PK__Messages__3213E83F8978BAAA on table Messages ... 
ALTER TABLE Messages
ADD CONSTRAINT PK__Messages__3213E83F8978BAAA PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON Messages TO ROLE_migr;
...
PROMPT Creating Primary Key Constraint PK__Likes__3213E83F1E2E2432 on table Likes ... 
ALTER TABLE Likes
ADD CONSTRAINT PK__Likes__3213E83F1E2E2432 PRIMARY KEY
(
  id
)
ENABLE
...
GRANT ALL ON Likes TO ROLE_migr;
...
alter session set current_schema=SocialNetwork2;
set define off
PROMPT Creating Foreign Key Constraint FK__Messages__Sender__34C8D9D1 on table Users...
ALTER TABLE Messages
ADD CONSTRAINT FK__Messages__Sender__34C8D9D1 FOREIGN KEY
(
  SenderId
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint FK__Likes__user_id__2E1BDC42 on table Users...
ALTER TABLE Likes
ADD CONSTRAINT FK__Likes__user_id__2E1BDC42 FOREIGN KEY
(
  user_id
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint FK__Likes__post_id__2D27B809 on table Post...
ALTER TABLE Likes
ADD CONSTRAINT FK__Likes__post_id__2D27B809 FOREIGN KEY
(
  post_id
)
REFERENCES Post
...
PROMPT Creating Foreign Key Constraint FK__Friendshi__user___31EC6D26 on table Users...
ALTER TABLE Friendships
ADD CONSTRAINT FK__Friendshi__user___31EC6D26 FOREIGN KEY
(
  user_id_2
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint FK__Comment__user_id__2A4B4B5E on table Users...
ALTER TABLE Comment_
ADD CONSTRAINT FK__Comment__user_id__2A4B4B5E FOREIGN KEY
(
  user_id
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint FK__Post__user_id__267ABA7A on table Users...
ALTER TABLE Post
ADD CONSTRAINT FK__Post__user_id__267ABA7A FOREIGN KEY
(
  user_id
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint FK__Friendshi__user___30F848ED on table Users...
ALTER TABLE Friendships
ADD CONSTRAINT FK__Friendshi__user___30F848ED FOREIGN KEY
(
  user_id_1
)
REFERENCES Users
...
PROMPT Creating Foreign Key Constraint FK__Comment__post_id__29572725 on table Post...
ALTER TABLE Comment_
ADD CONSTRAINT FK__Comment__post_id__29572725 FOREIGN KEY
(
  post_id
)
REFERENCES Post
...
PROMPT Creating Foreign Key Constraint FK__Messages__Receiv__35BCFE0A on table Users...
ALTER TABLE Messages
ADD CONSTRAINT FK__Messages__Receiv__35BCFE0A FOREIGN KEY
(
  ReceiverId
)
REFERENCES Users
